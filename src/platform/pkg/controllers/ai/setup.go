...
// SetupWithManager registers all AI controllers with the multicluster manager.
func SetupWithManager(mgr mcmanager.Manager) error {
	if err := notebooks.SetupWithManager(mgr); err != nil {
		return err
	}
	return gpujobs.SetupWithManager(mgr)
}
